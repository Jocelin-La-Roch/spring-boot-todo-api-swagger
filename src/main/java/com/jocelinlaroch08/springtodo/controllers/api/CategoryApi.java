package com.jocelinlaroch08.springtodo.controllers.api;
...
public interface CategoryApi {
    ...
    ResponseEntity<List<TodoDto>> getAllTodoByCategoryId(
    ...
    ResponseEntity<List<TodoDto>> getAllTodoByCategoryForToday(
            @ApiParam(value = "User ID", required = true) @PathParam("userId") Long categoryId
    );
    ...
    ResponseEntity<List<CategoryDto>> getAllCategoryByUserId(
