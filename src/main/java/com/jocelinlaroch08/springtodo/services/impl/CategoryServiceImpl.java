package com.jocelinlaroch08.springtodo.services.impl;

import com.jocelinlaroch08.springtodo.dto.CategoryDto;
import com.jocelinlaroch08.springtodo.exception.EntityNotFoundException;
import com.jocelinlaroch08.springtodo.exception.ErrorCodes;
import com.jocelinlaroch08.springtodo.exception.InvalidEntityException;
import com.jocelinlaroch08.springtodo.repositories.CategoryRepository;
import com.jocelinlaroch08.springtodo.services.CategoryService;
import com.jocelinlaroch08.springtodo.validators.CategoryValidator;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public List<CategoryDto> getAllTodoByCategoryForToday(Long userId) {
        return categoryRepository.getAllTodoByCategoryForToday(ZonedDateTime.now().withHour(0).withMinute(0),
